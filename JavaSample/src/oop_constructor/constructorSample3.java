...
public class constructorSample3 {
	...
	public constructorSample3(int value) { // 0 -> 100 => 90 => 80 => 70 => 60
		this.value = value; // 0 -> 100 => 90 => 80 => 70 => 60
	}

	public void Process() {
	String gender = (value == 1)? "남자": (value == 2)? "여자":
			(value == 3)? "남자": (value == 4)? "여자": "다시 입력해주세요";
...
*/
	...
	public static void main(String[] args) {
		...
		while (run) {
			...
			constructorSample3 css = new constructorSample3(value); // 100
			css.Process();
