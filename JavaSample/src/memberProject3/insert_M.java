...
public class insert_M  extends Access_M implements SpecData_M {
	...
	public void insert_accessProcess() {
		...
		String sql = "insert into member(mem_no, mem_name, mem_gender, mem_propertym, mem_height, mem_weight, mem_age, mem_paym, mem_exercise, mem_drink, mem_smoking)"
				 + "values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
		...
		try {
			...
			pstmt.setInt(4, mem_propertym);	
			pstmt.setDouble(5, mem_height);
			pstmt.setDouble(6, mem_weight);
			pstmt.setInt(7, mem_age);	
			pstmt.setInt(8, mem_paym);
			pstmt.setString(9, mem_exercise);
			pstmt.setString(10, mem_drink);
			pstmt.setString(11, mem_smoking);
